...
final class LandscapeVerifyingViewController: BaseViewController {
...
extension LandscapeVerifyingViewController {
    func finish() {
...
extension LandscapeVerifyingViewController: FooterViewDelegate {
    func feedbackTapped() {
